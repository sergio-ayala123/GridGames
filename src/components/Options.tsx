...
const Options: React.FC<{sendValues: (rows: number, columns: number, speed: number, obstacles: number,diagonalNeighbors:boolean)=>void}> = (props) => {
            ...
            <div style={{border:"solid cyan thin", borderRadius:"20px", padding:"5em", backgroundColor:"#1A0933"}}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{display:"flex", flexDirection:"column", justifyContent:'center'}}>
                        ...
                        <input type="checkbox" style={{height:'30px', width:'30px'}} onChange={(e) => setDiagonalNeighbors(!diagonalNeighbors)} />
                    </div>
                </div>
                <br />
            </div>
